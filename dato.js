const proyectos = [
    ...
    },
    {
        ...
        Descripción: "Juego desarrollado en Phaser, framework especializado para videojuegos",
        link: "https://jorgar.github.io/Memorita/",
        imagen: "./img/memo.jpg",
        Tecnologias: ["javaScript,", "HTML,", "CSS,", "DOM"]
    },
    {
        Titulo: "Traductor de palabras",
        Descripción: "Haciendo uso del DOM y de una API para consumir datos y trabajarlos en javaScript para tener un bonito traductor",
        link: "https://jorgar.github.io/Traductor/",
        imagen: "./img/traductor.webp",
        Tecnologias: ["HTML,", "CSS", "javaScript"]
    },
    {
        Titulo: "Plataforma de Comentarios",
        Descripción: "Descripción de las diferentes tecnologías extistentes hasta la fecha",
        link: "https://jorgar.github.io/tecnologia/",
        imagen: "./img/tecno.png",
        Tecnologias: ["REACT,", "javaScript,", "HTML,", "CSS"]
    },
    {
        Titulo: "Calculadora Dinámica",
        Descripción: "Basado en el lenguaje de programación javaScript, se hace una plicación numérica",
        link: "https://jorgar.github.io/Calculadora-Interactiva/",
        imagen: "./img/calcu.avif",
        Tecnologias: ["javaScript,", "HTML,", "CSS"]
    },
    {
        Titulo: "Pokémon API",
...
const datosPersonales = {
    ...
    imagen: './img/gotty.png',
    Otros: [
        ['Nacionalidad', 'Guatemalteco'],
        //['Edad', new Date(new Date() - new Date('1985/05/26')).getFullYear() - 1970 + ' años'],
        ['Profesión', 'Prog. FrontEnd']
    ],
    idiomas: [
    ...
    tecnologias: [
        ['REACT', 7], ['JAVASCRIPT', 7], ['NODE', 5], ['HTML', 8], ['CSS', 8], ['JSON', 6]
    ],
    redes: [
